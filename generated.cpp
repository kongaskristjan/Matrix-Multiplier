...
void Matrix::local_mul8x8(Matrix_view ret, Const_matrix_view ma, Const_matrix_view mb,
	   size_t x0, size_t y0, size_t n0)
{
	size_t da = ma.delta, db = mb.delta, dr = ret.delta;
...
void Matrix::local_mul16x16(Matrix_view ret, Const_matrix_view ma, Const_matrix_view mb,
	     size_t x0, size_t y0, size_t n0)
{
	size_t da = ma.delta, db = mb.delta, dr = ret.delta;
	__m256 r0, r1, r2, r3, r4, r5, r6, r7;
